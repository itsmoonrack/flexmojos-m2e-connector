...
/**
 * Flash Builder abstract components configuration.
 * 
 * Depending on the version of FlashBuilder, a specialized version of this module refines the implementation of the
 * abstraction interface AbstractProjectConfigurator.
 * 
...
public abstract class FlashBuilderAbstractModule extends AbstractModule {
  ...
  public FlashBuilderAbstractModule(final ProjectConfigurationRequest request, final IProgressMonitor monitor) {
    this.facade = request.getMavenProjectFacade();
    this.monitor = monitor;
    this.session = request.getMavenSession();
  }
  ...
  private Class<? extends IMavenFlexPlugin> getMavenFlexPluginClass() {
    try {
      ...
      flexmojos = facade.getMojoExecutions("net.flexmojos.oss", "flexmojos-maven-plugin", monitor, "compile-swf");
      ...
      flexmojos = facade.getMojoExecutions("org.sonatype.flexmojos", "flexmojos-maven-plugin", monitor, "compile-swf");
